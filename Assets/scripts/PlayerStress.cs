...
public class PlayerStress : MonoBehaviour
{
    ...
    public float maxCrouchCost = 3f;     // custo m�ximo
    public float crouchEscalationRate = 1f; // qu�o r�pido o custo aumenta

    private float crouchTime;            // quanto tempo seguido est� agachado
    ...
    public void Stress(float amount)
    {
        ...
        if (currentStress >= maxStress && !isStunned)
        {
            ...
            if (shake != null)
            {
                shake.TriggerShake(1.5f, stunDuration);  // shake m�dio por 2 segundos
            }
        }
    }
    void HandleStun()
